...
void CFW_nvSetPsmEnable(uint8_t psmEnable);
uint8_t CFW_nvGetPsmT3412(void);
void CFW_nvSetPsmT3412(uint8_t t3412Val);
uint8_t CFW_nvGetPsmT3324(void);
void CFW_nvSetPsmT3324(uint8_t t3324Val);
uint8_t CFW_nvGetEdrxEnable(void);
void CFW_nvSetEdrxEnable(uint8_t enable);
uint8_t CFW_nvGetEdrxValue(void);
void CFW_nvSetEdrxValue(uint8_t value);
uint8_t CFW_nvGetEdrxPtw(void);
void CFW_nvSetEdrxPtw(uint8_t ptw);
uint32_t CFW_GprsSetEdrx(uint8_t edrxEnable, uint8_t edrxType, uint8_t edrxValue, uint8_t nSimID);
void CFW_nvSetCiotNonip(uint8_t nonip);
void CFW_nvSetCiotCpciot(uint8_t cpciot);
void CFW_nvSetCiotUpciot(uint8_t upciot);
...
uint8_t CFW_nvGetCiotErwopdn(void);
uint8_t CFW_nvGetCiotSmsWoCombAtt(void);
uint8_t CFW_nvGetCiotApnRateCtrl(void);
#endif
