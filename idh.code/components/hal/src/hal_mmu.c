...
static uint32_t gHalMmuTableL1[4096] OSI_SECTION(.TTBL1);
static uint32_t gHalMmuTableL2Rom[256] OSI_SECTION(.TTBL2);
static uint32_t gHalMmuTableL2Sram[256] OSI_SECTION(.TTBL2);
static uint32_t gHalMmuTableL2ExtRam[256 * (CONFIG_RAM_SIZE >> 20)] OSI_SECTION(.TTBL2);
