...
static int prvUartFifoRead(HWP_UART_T *hwp, void *data, unsigned size)
{
...
static int prvUartFifoWrite(HWP_UART_T *hwp, void *data, unsigned size)
{
    REG_UART_STATUS_T status = {hwp->status};
...
#define UART_BLUESCREEN_DIVIDER (UART_DIV_NUM(576) | UART_DIV_DENOM(8125))
#elif defined(CONFIG_SOC_8909)
#define UART_BLUESCREEN_DIVIDER (UART_DIV_NUM(1001) | UART_DIV_DENOM(1765))
#endif
#endif
...
void drvUartBlueScreenInit(void)
{
    ...
    case DRV_NAME_UART1:
        d->hwp = hwp_uart;
        hwp_sysCtrl->cfg_clk_uart[1] = UART_BLUESCREEN_DIVIDER | UART_DIV_UPDATE;
        break;

    case DRV_NAME_UART2:
        d->hwp = hwp_uart2;
        hwp_sysCtrl->cfg_clk_uart[2] = UART_BLUESCREEN_DIVIDER | UART_DIV_UPDATE;
        break;
    }
#endif
    ...
    case DRV_NAME_UART1:
        d->hwp = hwp_uart1;
        sel_clock.b.sel_clk_uart1 = 0;
        hwp_sysCtrl->cfg_clk_uart[0] = UART_BLUESCREEN_DIVIDER;
        break;

    case DRV_NAME_UART2:
        d->hwp = hwp_uart2;
        sel_clock.b.sel_clk_uart2 = 0;
        hwp_sysCtrl->cfg_clk_uart[1] = UART_BLUESCREEN_DIVIDER;
        break;

    case DRV_NAME_UART3:
        d->hwp = hwp_uart3;
        sel_clock.b.sel_clk_uart3 = 0;
        hwp_sysCtrl->cfg_clk_uart[2] = UART_BLUESCREEN_DIVIDER;
        break;
    }
