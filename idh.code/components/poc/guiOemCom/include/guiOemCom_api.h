...
#define LVPOCPOCOEMCOM_SIGNAL_OPTCODE_SETVOLUM               "25000000"  //请求设置音量
#define LVPOCPOCOEMCOM_SIGNAL_OPTCODE_NOTETONE               "7C0000"  //请求开关提示音
#define LVPOCPOCOEMCOM_SIGNAL_OPTCODE_OPEN_LOG               "7E0000"//开关LOG
...
#define    LVPOCPOCOEMCOM_SIGNAL_OPTCODE_STARTSPEAK_ACK          "960000"   //开始讲话成功应答
#define    LVPOCPOCOEMCOM_SIGNAL_OPTCODE_STOPSPEAK_ACK           "960001"   //停止讲话成功应答
#define    LVPOCPOCOEMCOM_SIGNAL_OPTCODE_CALLOUT_FAILED_ACK      "960002"   //呼叫失败应答
#define    LVPOCPOCOEMCOM_SIGNAL_OPTCODE_STARTLISTEN_ACK         "960003"   //开始接听成功应答
#define    LVPOCPOCOEMCOM_SIGNAL_OPTCODE_STOPLISTEN_ACK          "960004"   //停止接听成功应答
