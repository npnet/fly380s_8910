...
#define    LVPOCPOCOEMCOM_SIGNAL_OPTCODE_AUDIOQUILITY           "300000"//请求通话音质
#define    LVPOCPOCOEMCOM_SIGNAL_OPTCODE_HEARTBEAT              "7A0000"//请求心跳时间
#define    LVPOCPOCOEMCOM_SIGNAL_OPTCODE_POWER_SAVE             "3D0000"//请求省电模式
...
#define    LVPOCPOCOEMCOM_SIGNAL_OPTCODE_NOTE_INFO_ACK           "POC:84"   //提示信息信息
...
#define    LVPOCPOCOEMCOM_SIGNAL_OPTCODE_USERNAME_UPDATE_ACK     "POC:87"   //用户名字更新
#define    LVPOCPOCOEMCOM_SIGNAL_OPTCODE_CHECK_QUILITY_MODE_ACK  "POC:30"   //检查音质模式
