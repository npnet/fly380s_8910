...
typedef enum{
	...
	//led
	LVPOCLEDIDTCOM_SIGNAL_REGISTER_STATUS ,//注册
	...
	LVPOCGUIIDTCOM_SIGNAL_PING_FAILED_IND,
    LVPOCGUIOEMCOM_SIGNAL_HEADSET_INSERT,
	LVPOCGUIOEMCOM_SIGNAL_HEADSET_PULL_OUT,
	//cit
	LVPOCGUICOM_SIGNAL_LOOPBACK_RECORDER_IND,
    LVPOCGUICOM_SIGNAL_LOOPBACK_PLAYER_IND,
    LVPOCGUICOM_SIGNAL_TEST_VLOUM_PLAY_IND,
...
typedef enum{//刷新机制周期
	...
	LVPOCLISTIDTCOM_LIST_PERIOD_30 = 30,
