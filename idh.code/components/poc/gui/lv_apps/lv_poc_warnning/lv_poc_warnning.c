...
static lv_obj_t * prv_lv_poc_warnning_activity_create(lv_poc_display_t *display)
{
	...
	lv_obj_align(warnning->prv_title_obj,warnning->prv_base_obj,LV_ALIGN_IN_TOP_LEFT,5,5);/*text 偏移*/
	...
	lv_obj_align(warnning->prv_context_obj,warnning->prv_base_obj,LV_ALIGN_IN_LEFT_MID, 5, -2);
