...
typedef enum
{
    ...
    ABUP_ERROR_TYPE_NO_NETWORK,//2	//无网络
    ABUP_ERROR_TYPE_DNS_FAIL,// 3	//DNS解析失败
    ABUP_ERROR_TYPE_CREATE_SOCKET_FAIL,//4
    ABUP_ERROR_TYPE_NETWORK_ERROR,// 5
    ABUP_ERROR_TYPE_NO_NEW_UPDATE,//6		//无最新版本
    ABUP_ERROR_TYPE_MD5_NOT_MATCH,// 7	//MD5校验失败
    ABUP_ERROR_TYPE_NOT_ENOUGH_SPACE,//8	//空间不足
    ABUP_ERROR_TYPE_ERASE_FLASH,// 9
    ABUP_ERROR_TYPE_WRITE_FLASH,//10
    ABUP_ERROR_TYPE_NO_ACCESS_TIMES,// 11	//当天此IMEI达到最大访问次数 ,100次
    ABUP_ERROR_TYPE_UNKNOW,//12
